...
# ----------------------------------------------------
# Challenge 6.1
# The main objetive of this challenge is to plot the maximum sea surface temperature in Europe for the year 2100 under two contrasting scenarios of climate change (RCP26 and RCP85)
...
# ----------------------------------------------------
# Challenge 6.2
# The main objetive of this challenge is to plot the difference in global maximum sea surface temperature between the present and the year 2100 under two contrasting scenarios of climate change (RCP26 and RCP85)
...
# ----------------------------------------------------
# Challenge 6.3
# The main objetive of this challenge is to plot the difference in sea ice thickness between the present and the year 2100 under two contrasting scenarios of climate change (RCP26 and RCP85).
...
# ----------------------------------------------------
# Challenge 6.4
# The main objetive of this challenge is to plot the difference in sea temperature between the surface and bottom layers of the ocean.
...
# ----------------------------------------------------
# Challenge 6.5
# The main objetive of this assignment is to extract the environmental use (values) of the mediterranean coral Paramuricea clavata for the present. Use GBIF data for this assignment.
